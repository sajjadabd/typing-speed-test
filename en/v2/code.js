//let Fireworks = require('fireworks-js');
...
let numberOfCharacters = content.length;

let numOfCharactersContainer = document.getElementById('numberOfCharacters');
let wordsCounter = 0;
...
let showResult = () => {
	...
	numOfCharactersContainer.innerText = numberOfCharacters;
	...
	time.innerText = `Finished in ${ seconds }.${ milliseconds } seconds`;
}
